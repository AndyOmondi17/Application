...
public class GiantBombSearchResponse {
     ...
     * @param statusCode
     */
    public GiantBombSearchResponse(String error, Integer limit, Integer offset, Integer numberOfPageResults, Integer numberOfTotalResults, Integer statusCode, List<Result> results, String version) {
        super();
        this.error = error;
        this.limit = limit;
        this.offset = offset;
